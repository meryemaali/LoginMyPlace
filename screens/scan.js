...
import styles from './../components/scanStyle'
                ...
                <Fragment>
                    <View style={styles.header}>
                        <TouchableOpacity onPress={()=> BackHandler.exitApp()}>
                            <Image source={require('./../assets/img/logo.png')} style={{height: 36, width: 36}}></Image>
                        </TouchableOpacity>
                    ...
                    {!scan && !ScanResult &&
                        <View style={styles.cardView} >
                            ...
                            <Image source={require('./../assets/img/logo.png')} style={{margin: 20}}></Image>
                    ...
                    {scan &&
                        <QRCodeScanner
                            ...
                            bottomContent={
                                <View>
                                    <ImageBackground source={require('./../assets/img/logo.png')} style={styles.bottomContent}>
