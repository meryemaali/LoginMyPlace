      ...
      >
        ...
        >
          <Animated.View
            style={[
              {
                backgroundColor: isSelected ? '#d60a06' : '#FF5500',
              },
              styles.item,
              {
                transform: [
    ...
    return (
      <View style={styles.container}>
        ...
        >
          ...
          />*/}
          <Text style={{fontSize: 14, fontWeight: '700', color: '#333',textAlign: 'center',paddingLeft: 150}}>
            Select a seat
          </Text>
        ...
        >
          ...
          <StyledButton onPress={this.gotoqr}>
